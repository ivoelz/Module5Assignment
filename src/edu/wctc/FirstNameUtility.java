...
public class FirstNameUtility {
    ...
    public int encodeFirstName(String firstName, String middleInitial) throws MissingNameException {
        ...
        //	returns the sum of the codes for the first name and middle initial. If not, it returns the sum of the codes for the first initial and middle initial. If a person has no middle initial, return only the first name or first initial code.
        int midInitial;
        if (middleInitial != null && !middleInitial.equals("")) {
            midInitial = middleInitialCodeMap.get(middleInitial);
        } else {
            midInitial = 0;
        }
        ...
        if (firstName == null || firstName.isEmpty()) {
            ...
            if (firstNameCodeMap.containsKey(firstName)) {
                return firstNameCodeMap.get(firstName) + midInitial;
            } else {
                return firstInitialCodeMap.get(Character.toString(Character.toUpperCase(firstName.charAt(0)))) + midInitial;
            }
        }
    }
